# main.py
# ============================================================
# ENTRY POINT — FINAL POLISHED VERSION WITH SOUND + MISSILE TYPES
# ============================================================
...
def draw_legend():
    """Draw missile type legend bottom left."""
    px = 15
    py = 740
    screen.blit(font_small.render("◈ MISSILE TYPES",
                True, config.RADAR_GREEN), (px, py))
    pygame.draw.line(screen, config.DIM_GREEN,
                     (px, py + 16), (px + 180, py + 16), 1)
    types = [
...
def draw_hud_frame():
    ...
    screen.blit(font_small.render(
        "KALMAN TRACKING  |  THREAT SCORING AI  "
        "|  AUTO INTERCEPT  |  REAL-TIME PREDICTION",
