...
MISSILE_SPEED_MIN   = 0.4    # slower missiles
MISSILE_SPEED_MAX   = 0.9    # easier to intercept
INTERCEPTOR_SPEED   = 5.0    # faster interceptors
MISSILE_SPAWN_RATE  = 90     # more frequent spawns
